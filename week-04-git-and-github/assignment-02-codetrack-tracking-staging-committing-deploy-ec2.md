...
![alt text](<screenshots/Week 4 Assignment_Screenshot 5.png>)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![alt text](<screenshots/Week 4 Assignment_Screenshot 6.png>)
...
![alt text](<screenshots/Week 4 Assignment_Screenshot 7.png>)
...
![alt text](<screenshots/Week 4 Assignment_Screenshot 8.1-1.png>)
![alt text](<screenshots/Week 4 Assignment_Screenshot 8.2.png>)
---
...
![alt text](<screenshots/Week 4 Assignment_Screenshot 9.png>)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![alt text](<screenshots/Week 4 Assignment_Screenshot 10.png>)
...
![alt text](<screenshots/Week 4 Assignment_Screenshot 11.png>)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![alt text](<screenshots/Week 4 Assignment_Screenshot 12.png>)
...
![alt text](<screenshots/Week 4 Assignment_Screenshot 13.png>)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![alt text](<screenshots/Week 4 Assignment_Screenshot 14-1.png>)

---

#### Screenshot 11 — Output of `git commit`

![alt text](<screenshots/Week 4 Assignment_Screenshot 14.png>)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![alt text](<screenshots/Week 4 Assignment_Screenshot 15.png>)
...
![alt text](<screenshots/Week 4 Assignment_Screenshot 16.png>)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![alt text](<screenshots/Week 4 Assignment_Screenshot 17.png>)

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![alt text](<screenshots/Week 4 Assignment_Screenshot 18.png>)
...
https://www.linkedin.com/posts/ossa-agharese-01991a233_dmi-devops-micro-internship-with-agentic-share-7485924171345170433-3Mgh/?utm_source=share&utm_medium=member_desktop&rcm=ACoAADpVsJUBYBjWiWLSBz1ZojH27wf_yizZYUA

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![alt text](<screenshots/Week 4 Assignment_Screenshot 18-1.png>)
