...
![alt text](<Week 07 Assignment 01_Screenshot 1.png>)

---

#### Screenshot 2 — "Subscriptions" section showing the "Free Trial" subscription

![alt text](<Week 07 Assignment 01_Screenshot 2.png>)
...
I plan to explore **Azure Virtual Machines, Azure Kubernetes Service (AKS), Azure DevOps, and Azure Monitor** first. These services will help me strengthen my practical skills in cloud infrastructure, container orchestration, CI/CD automation, and monitoring. I also want to use **Terraform with Azure** to practice Infrastructure as Code and build secure, repeatable cloud environments.
