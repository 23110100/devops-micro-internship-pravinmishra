...
![alt text](<screenshots/Week 02_Assignment 03_Screenshot 1-1.png>)
...
![alt text](<screenshots/Week 02_Assignment 03_Screenshot 2-1.png>)

---

#### Screenshot 3 — Screenshot 3 — `tf-plan/SKILL.md` frontmatter showing `allowed-tools: Bash, Read, Grep` (no Write) and `disable-model-invocation: true`

![alt text](<screenshots/Week 02_Assignment 03_Screenshot 3-1.png>)
...
![alt text](<screenshots/Week 02_Assignment 03_Screenshot 4-1.png>)

---

#### Screenshot 5 — VS Code sidebar showing the `terraform/` folder with all generated files inside

![alt text](<screenshots/Week 02_Assignment 03_Screenshot 5-1.png>)
...
![alt text](<screenshots/Week 02_Assignment 03_Screenshot 6-1.png>)
