...
![alt text](<Week 06 Assignment 03_Screenshot 3.png>)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![alt text](<Week 06 Assignment 03_Screenshot 4.png>)
![alt text](<Week 06 Assignment 03_Screenshot 4.1png.png>)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![alt text](<Week 06 Assignment 04_Screenshot 3.png>)
...
![alt text](<Week 06 Assignment 04_Screenshot 6.1.png>)
![alt text](<Week 06 Assignment 04_Screenshot 6.png>)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![alt text](<Week 06 Assignment 04_Screenshot 7.png>)
...
![alt text](<Week 06 Assignment 04_Screenshot 8.png>)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![alt text](<Week 06 Assignment 04_Screenshot 10.png>)

---

#### Screenshot 10 — Output of `mysql --version`

![alt text](<Week 06 Assignment 04_Screenshot 11.png>)
...
![alt text](<Week 06 Assignment 04_Screenshot 9.png>)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![alt text](<Week 06 Assignment 04_Screenshot 12.png>)
...
![alt text](<Week 06 Assignment 04_Screenshot 13.png>)
...
![alt text](<Week 06 Assignment 04_Screenshot 17.png>)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![alt text](<Week 06 Assignment 04_Screenshot 18.png>)
